...
<template>
  ...
  <div class="task-card" :class="{ completed: task.done }">
    ...
    <div class="task-actions">
      ...
      <button v-if="!task.done" @click="emit('complete', task.id)" class="btn-complete">Complete</button>
      <button v-if="task.done"  @click="emit('complete', task.id)" class="btn-complete">Undo</button>
